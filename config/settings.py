...
SECRET_KEY = "django-insecure-t9*@r^99#%=t&3u%swpm+bohd)@uc*436pba+wl-pr3*haq%f_"
...
if DEBUG:
    INTERNAL_IPS = ["127.0.0.1", "192.168.224.128"]
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "mainapp.context_processors.simple.simple_context_processor",
...
LOGIN_REDIRECT_URL = "mainapp:news"
